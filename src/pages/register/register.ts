...
import { User, Test, File,
  ...
  USER_EDIT,
  FILE_UPLOAD
} from './../../app/angular-backend/angular-backend';
...
export class RegisterPage implements OnInit{
  ...
  ngOnInit(){
    ...
    console.log('user_photo_idx :: ' , this.user_photo_idx );
  ...
  onChangeFileUpload( fileInput ) {
    ...
    if( this.user.logged ) req.model_idx = this.userData.idx;
